...
class ApplePayReferenceFactory extends Factory
{
    protected $model = ApplePayReference::class;
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'applepayable_type' => 'App\\Models\\Order',
            'applepayable_id' => $this->faker->numberBetween(1, 1000),
        ];
    }
